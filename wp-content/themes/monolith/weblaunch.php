 ...
 */
/*
Template Name: Monolith Weblaunch
 */

?>

<?php get_header('weblaunch'); $currentLang="en"; ?>
    ...
    <body>
        ...
        <div class="header-container" id="section-header-ca">
            <div class="monolith-logo">
                <img src="<?php echo get_template_directory_uri(); ?>/images/monolith.png" alt="Monolith Logo" />
                <p class="weblaunch-logo-text-fr">Monolith</p>
            </div>
            ...
            <div class="nav-social hidden-md hidden-lg">
                <ul class="menu social-links-menu-dark text-right">
                    <li><a class="social-media-icons" href="https://www.facebook.com/monolith.technology/"><img src="<?php echo get_template_directory_uri(); ?>/images/fb-social-icon-black.png" alt="" /></a></li>
                    <li><a class="social-media-icons" href="https://twitter.com/monolith_tech"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter-social-icon-black.png" alt="" /></a></li>
                    <li><a class="social-media-icons" href="https://github.com/Monolith-Technology"><img src="<?php echo get_template_directory_uri(); ?>/images/youtube-social-icon-black.png" alt="" /></a></li>
                </ul>
            </div>
            <br /><br /><h1 class="header-title shadow-text-dark">Weblaunch</h1>
            <div class="row">
                <span class="fancy-quotations">"</span>Web solution for your business<span class="fancy-quotations">"</span><br />
            </div>
        </div>
        ...
        <script>
            ...
            function init() {
                ...
                container.className= "birdswrapper";
        ...
        <div class="main-content-container">
            <div class="container-fluid section-highlight" id="section-highlight1">
                <div class="row">
                    <div class="ellipse-overlay hidden-xs hidden-sm"></div>
                    <h3 class="white-text shadow-text-grey">Since 2013, we are helping small businesses to reach their audience online. We specialize in web development, search engine optimization and social media marketing.</h3>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="bx-wrapper-row2">
                        <ul class="scrollable-text bxslider-sliding-text">
                            <li><p>We use a formidable combination of tools, software development process and best practices.</p></li>
                            <li><p>We value customer communication above all.</p></li>
                            <li><p>By working in iterations and reviewing, we deliver the product most suitable for your business.</p></li>
                            <li><p>You can get honest feedback on your customers from our experienced team.</p></li>
                            <li><p>Create marketing pipelines with our meta information system.</p></li>
                            <li><p>We help you to identify and correct any issue you may have overlooked.</p></li>
                        </ul>
                    </div>
                    <br /><br />
                </div>
            ...
            <div class="container-fluid section-highlight" id="section-highlight3">
                <div class="row">
                    <p>
                        In a nutshell <strong><br />
                        We work as</strong><br />
    ...
    <div id="dates">
                            ...
                            <table class="the-stack">
                                ...
                                <tbody>
                                    <tr class="grey-table-row">
                                        <td>Domain Name Control</td>
                                        <td>Y</td>
                                        <td>Y</td>
                                        <td>Y</td>
                                    </tr>
                                    <tr class="grey-table-row">
                                        <td>Site Installation</td>
                                        <td>Y</td>
                                        <td>Y</td>
                                        <td>Y</td>
                                    </tr>
        ...
        <!--</div>
            ...
            <div class="container-fluid section-highlight" id="section-highlight5">
                <div class="row">
                    <p>Reach us.<br /><small>Anytime.</small></p>
                </div>
            </div>
            <div class="container-fluid section-highlight" id="section-highlight7">
                <div class="row">
                    <p>Already have your web properties and want to improve?</p>
                    <br />
                    <a class="btn btn-lg btn-info" href="<?php bloginfo('url'); ?>/consultancy/">Learn more about Monolith consultancy<img class="white-arrow" src="<?php echo get_template_directory_uri(); ?>/images/shape_1.png" alt="Arrow" /></a>
                </div>
            </div>
        </div>

<?php get_footer('weblaunch'); ?>
